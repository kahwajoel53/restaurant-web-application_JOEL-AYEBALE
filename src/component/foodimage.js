...
const Food=[
    ...
    },
    {
        ...
        quantity:'2 pieces',
        star:4.5,
        description:'A thin and crispy pancake prepared with fermented joel butter which is topped with red garlic chutney and potato masala. the appearance and texture is very similar to world famous masala dosa. but the main difference lies with the red garlic chutney spread topped on cream cheese.',
        fakerate:900,
        titlename:'IndianFood',
        titleId:1
    },
    ...
    },
    {
        ...
        quantity:'1 Serve',
        star:3,
        description:"The best aromatic ayebale posho topped with vegetables and ghee and it comes with more vegetables. Staying consious of one's health is the way to go, thus is a light upma made of wheat grains and vegetable ",
        titlename:'IndianFood',
        titleId:1
    },
    {
    ...
    },
    {
        ...
        {id:2.5,
            url:require("../component/Dashboard/image/italifood-5.jpg"),
                rate:'200',
                title:'Joel Tira Cake',
                quantity:'1 serve',
                star:4.5,
                titlename:'ItalianFood',
                titleId:2,
                description:'Joel Tira Cake is a velvety cookie cake dipped in an espresso, layered with delicately sweetened whipped eggs and mascarpone cheese, and topped with a dusting of cocoa powder.'},
        {id:2.6,
